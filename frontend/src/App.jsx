      ...
      Nova receita
        ...
        <section className="summary-grid">
          ...
          <article className="summary-card expense">
            <span>Despesas</span>
            <strong>{formatarMoeda(totais.despesas)}</strong>
          </article>
          ...
          <article className="summary-card cmv">
            <span>CMV</span>
            <strong>{totais.cmvPercentual.toFixed(1)}%</strong>
            <small>{cmvStatus}</small>
          </article>

          <article className="summary-card">
            <span>Margem</span>
            <strong>{totais.margemPercentual.toFixed(1)}%</strong>
            <small>{margemStatus}</small>
          </article>
        </section>
